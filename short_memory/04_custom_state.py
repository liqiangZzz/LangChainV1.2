...
# =====================================================================
# 2. 声明自定义 state —— 让 Agent 知道哪些业务字段可以保存
# =====================================================================
...
# =====================================================================
# 3. 注入动态提示词 —— state 不是模型可见内容，必须显式塞进去
# =====================================================================
@dynamic_prompt
...
# =====================================================================
# 4. 创建 Agent —— state_schema 保存字段，middleware 暴露字段
# =====================================================================
def build_agent():
...
# =====================================================================
# 6. 运行两轮对话 —— 第一轮写 state，第二轮读 state
# =====================================================================
def main() -> None:
